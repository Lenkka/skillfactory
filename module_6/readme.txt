...
1. Составить план анализа (применен pandas.profiling), оценить данные и сделать выводы. 
   Ссылка на ноутбук с результатами на Kaggle: https://www.kaggle.com/lenkavinogradova/pandas-profiling-for-car-selection
   Ссылка на ноутбук с результатами на github: https://github.com/Lenkka/skillfactory/blob/master/module_6/pandas-profiling-for-car-selection.ipynb
...
Не хватило времени и сил на написание собственного парсинга, а при попытке воспользоваться результатом программы парсинга (https://github.com/Lenkka/skillfactory/blob/master/module_6/parsing_auto_ru-end.ipynb) - на приведение в соответствие внутренних и внешних результатов (https://www.kaggle.com/lenkavinogradova/proba-car-selection-2a или https://github.com/Lenkka/skillfactory/blob/master/module_6/proba-car-selection-2a.ipynb)
...
0. Заняться парсингом и создать нормальный файл, тщательно почистив признаки на этом этапе.
