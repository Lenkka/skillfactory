...
2. Составить план анализа (применен pandas.profiling), оценить данные и сделать выводы. Ссылка на ноутбук с результатами и выводами https://www.kaggle.com/lenkavinogradova/sf-dst-credit-scoring-profiling-vinogradova
