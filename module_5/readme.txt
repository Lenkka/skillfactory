...
0. Пригорюниться, что все сложно.
...
VI. Что мне удалось
0. Оно работает!
1. Неплохо, как мне кажется, расставлены комментарии к коду.
2. Код аккуратный.
3. Кое-какие инсайты в процессе (например, про метрики)
4. Некоторые вещи, которые в теории были непонятными, на практике прояснились. Но непонятного пока куда больше.
